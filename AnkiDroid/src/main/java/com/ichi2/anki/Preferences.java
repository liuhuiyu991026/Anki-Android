    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            case "com.ichi2.anki.prefs.general":
                ...
                /** Themis-#6145 */
                Log.i("Themis", "Event 3: Click \"AnkiDroid\" in Preferences.");
                ...
                language.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        if (((String)newValue).equals("zh_CN")) {
                            Log.i("Themis", "Event 4: Change language to " + newValue.toString());
                        } else {
                            Log.i("Themis", "Warning 4: Change language to other language (not Chinese).");
                        }
                        return true;
                    }
                });
            ...
            case "com.ichi2.anki.prefs.advanced":
                ...
                /** Themis-#6145 */
                Log.i("Themis", "Event 5: Click \"Advanced\" in Preferences.");
                ...
                schedVer.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        if (newValue.equals(true)) {
                            Log.i("Themis", "Event 6: Enable the \"Experimental V2 Scheduler\".");
                        } else {
                            Log.i("Themis", "Warning 6: Disable the \"Experimental V2 Scheduler\".");
                        }
