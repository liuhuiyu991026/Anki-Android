    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            ...
            case "com.ichi2.anki.prefs.reviewing":
                ...
                /** Themis-#4451 */
                Log.i("Themis", "Event 5: Click \""+ getString(R.string.pref_cat_reviewing)+"\" item in Preferences.");
                /** Themis-#4451 */
            ...
            case "com.ichi2.anki.prefs.gestures":
                ...
                /** Themis-#4451 */
                Log.i("Themis", "Event 3: Click \""+ getString(R.string.pref_cat_gestures)+"\" item in Preferences.");
                /** Themis-#4451 */
                ...
                /** Themis-#4451 */
                screen = listener.getPreferenceScreen();
                CheckBoxPreference gesturesMode = (CheckBoxPreference) screen.findPreference("gestures");
                gesturesMode.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                    @Override
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        if (newValue.equals(true)) {
                            Log.i("Themis", "Event 4: Enable gestures.");
                        } else {
                            Log.i("Themis", "Warning 4: Disable gestures.");
                        }
                        return true;
                    }
                });
